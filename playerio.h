...
void		my_werase();
void		my_clear();
void        print_stats_info(const game_state_type *state, const patient_type *patient);
void		my_refresh();
...
void        get_patient_state_strings(const patient_type *patient, char *mood_str, char *pat_str);
